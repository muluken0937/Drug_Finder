import {
  ...
  import FreeDrugAmh from "./FreeDrugAmh";
const FreeDrugListAmh = ({ navigation:{navigate} }) => {
  ...
  return (
    ...
    <View  style={{flexDirection:'row',alignItems:'flex-end', }}>
            ...
            <Ionicons name="home-outline" color={Colors.primary} size={Spacing*3}/>
              <Text style={{color:Colors.primary,fontSize:FontSize.small}}>ዋና ገጽ</Text>
            </TouchableOpacity >
            ...
            <Image style={{tintColor:Colors.primary,width:Layout.width*9/100,height:Layout.width*9/100}} source={require("../assets/images/drugstore.png")}></Image>
                <Text style={{color:Colors.primary,fontSize:FontSize.small}}>ፋርማሲ</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=>navigate('FreeDrugListAmh')}  style={{alignItems:'center',backgroundColor:Colors.primary,marginLeft:Layout.width/7,width:Layout.width/5, padding:Spacing,}}>
            <Image style={{tintColor:Colors.onPrimary,width:Layout.width*9/100,height:Layout.width*9/100}} source={require("../assets/images/drugstore.png")}></Image>
              <Text style={{color:Colors.onPrimary,fontSize:FontSize.small}}>መድሃኒት</Text>
            </TouchableOpacity>
          </View>
</SafeAreaView>
  )
...
export default FreeDrugListAmh