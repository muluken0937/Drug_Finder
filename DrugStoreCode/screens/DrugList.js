...
import { addToCartSuccess,removeFromCartSuccess } from "../store/action/action";
const DrugList = (category) => {
  ...
  const handleAddCart=()=>{
   ...
   .then(()=>{alert("Added successfully",setIsLoading(false),toggleFloatScreen4(),toggleFloatScreen2()),toggleFloatScreen(),dispatch(addToCartSuccess());}
